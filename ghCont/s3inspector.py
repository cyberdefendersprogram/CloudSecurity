...
def get_s3_obj(is_lambda=False):
    ...
    if is_lambda:
        ...
        if os.path.exists(os.path.join(expanduser("~"), ".aws", "credentials")) or os.path.exists(
            ...
            profile_name = input("Enter your AWS profile name [default]: ") or "default" # Correction: raw_input() --> input()
            ...
            access_key = input("Enter your AWS access key ID: ") # Correction: raw_input() --> input()
            secret_key = input("Enter your AWS secret key: ") # Correction: raw_input() --> input()
